...
const Quotes = () => {
  ...
  const handleFormSubmit = async () => {
    ...
    // AquÃ­ realizar la peticiÃ³n POST con los datos del formulario
    try {
      ...
      console.log('Respuesta de la peticiÃ³n POST:', response.data);

      // Cerrar el modal despuÃ©s de enviar la informaciÃ³n
      setModalVisible(false);
    } catch (error) {
      console.error('Error al enviar la peticiÃ³n POST:', error);
    }
  };
        ...
        >
          <View style={styles.modalContainer}>
            ...
            <TextInput
              ...
              selectTextOnFocus={false} // Para evitar la selecciÃ³n del texto al hacer foco
